...
class LiveDataCallAdapterFactory private constructor(): CallAdapter.Factory() {
    ...
    override fun get(
        ...
        require(rawObservableType == LiveDataResponse::class.java) { "type must be a LiveDataResponse" }
        require(observableType is ParameterizedType) { "LiveDataResponse must be parameterized" }
